### 1. **Programmatic Imitation Learning from Unlabeled and Noisy Demonstrations (PLUNDER)** (RA-L, 2024)
...
### 2 **Sensorless Force Estimation for Industrial Robots Using Disturbance Observer and Neural Learning of Friction Approximation** (RCIM 2021)
...
### 3. **Adaptive Neural Trajectory Tracking Control for n-DOF Robotic Manipulators With State Constraints** (IEEE TII, 2023)
...
### 4. **Robot Hybrid Inverse Dynamics Model Compensation Method Based on the BLL Residual Prediction Algorithm** (Tao et al., *Robotica*, 2025)
