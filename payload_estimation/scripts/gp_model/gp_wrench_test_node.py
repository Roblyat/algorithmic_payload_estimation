...
def load_test_data(test_csv):
    ...
    Y_test = df_test.iloc[:, -6:].values  # Targets: last 6 columns (Force/Torque)
...
def gp_test_node():
    ...
    output_folder = '/home/robat/catkin_ws/src/algorithmic_payload_estimation/payload_estimation/data/result/wrench'  # Path to save the results
