...
def load_training_data(training_csv, subsample_size=5000):
    """
    Loads the training data from a CSV file and subsamples if necessary.
...
def gp_training_node():
    ...
    full_train_csv_path = '/home/robat/catkin_ws/src/algorithmic_payload_estimation/payload_estimation/data/processed/100_02_02_01x3_effort__effort_train_data.csv'
    ...
    full_model_path = '/home/robat/catkin_ws/src/algorithmic_payload_estimation/payload_estimation/gp_models/effort_model.pkl'
